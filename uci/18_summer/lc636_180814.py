...
Given the running logs of n functions that are executed in a non-preemptive single threaded CPU, find the exclusive time 
of these functions.
...
should not be considered as this function's exclusive time. You should return the exclusive time of each function sorted 
by their function id.
...
class Solution:
    def exclusiveTime(self, n, logs):
        ...
        for fid, typ, time in (log.split(":") for log in logs):
...
if __name__ == '__main__':
    ...
    t = time()
    ans = sol.exclusiveTime(2, ["0:start:0","1:start:2","1:end:5","0:end:6"])
